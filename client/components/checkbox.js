...
export default function Checkbox({ id, text }) {
    ...
    return (
        <div onClick={() => {setTicked(!ticked)}} className="flex gap-4 items-center justify-center">
            <div className={`w-10 h-10 border-2 ${ticked ? "border-pink-500" : "border-white"} rounded-lg flex flex-col items-center justify-center`}>
